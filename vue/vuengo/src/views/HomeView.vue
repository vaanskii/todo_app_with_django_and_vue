  ...
  <div class="home">
    ...
    <div class="columns">
      <div class="column is-6">
        ...
        <div class="todo" v-for="task in tasks">
          <div class="card"  v-if="task.status === 'todo'" v-bind:key="task.id">
      ...
      <div class="column is-6">
        ...
        <div class="done" v-for="task in tasks">
          <div class="card" v-if="task.status === 'done'" v-bind:key="task.id">
            <div class="card-content">{{ task.description }}</div>
